# RQ1: Classify an image as a UML Use Case diagram or not
...
output_file = "RQ1_image_analysis_gpt_4o_mini.xlsx"
        ...
        "messages": [
            {
                ...
                "content": [
                    {
                        "type": "text",
                        "text": "You are a software Engineer. What type of diagram is this (answer with a maximum of 10 words)?"
                    },
                    {
                        "type": "image_url",
                        "image_url": {
