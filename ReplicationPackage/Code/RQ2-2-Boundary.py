# RQ2-2: Identification of a boundary in a UML class diagram
...
# OpenAI API Key
#api_key = "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"
...
output_file = "RQ2-2_Boundary_gpt_4o.xlsx"
wb = openpyxl.Workbook()
ws = wb.active
ws.append(["Image Name", "Response"])

# Specify the directory containing images
directory = "./gpt-4o-UCD"
        ...
        "messages": [
            {
                ...
                "content": [
                    {
                        "type": "text",
                        "text": "You are a software engineer. Examine the following image of a UML Use Case Diagram and determine if it includes a UCD boundary. Respond with 'yes' if there is a boundary and 'no' if there is not."
                    },
                    {
                        "type": "image_url",
                        "image_url": {
