...
output_file = "RQ2-3_nb_uc_gpt_4o.xlsx"
        ...
        "messages": [
            {
                ...
                "content": [
                    {
                        "type": "text",
                        "text": "You are a software engineer. Analyze the following image of a UML Use Case Diagram. How many use cases are depicted? Respond with the number only."
                    },
                    {
                        "type": "image_url",
                        "image_url": {
